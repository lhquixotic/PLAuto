...
private:
  ...
  bool is_waypoint_set_, is_pose_set_, is_velocity_set_, is_v2v_set_;
  ...
  double leader_distance_,leader_speed_, leader_acc_, leader_acc_pedal_, leader_brake_pedal_, leader_frontwheel_angle_;
  double kd,kv,ki;
