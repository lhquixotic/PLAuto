...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.obj_id))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.real_data))
      length = len(self.lifespan)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.lifespan))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.obj_id = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.rect_ranged = []
      ...
      self.real_data = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.lifespan = s.unpack(str[start:end])
      return self
