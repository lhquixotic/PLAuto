...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/user/code/PLAuto/src/control)
  set(control_DEVEL_PREFIX /home/user/code/PLAuto/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/user/code/PLAuto/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/code/PLAuto/src/control/${idir}'.  ${_report}")
    endif()
