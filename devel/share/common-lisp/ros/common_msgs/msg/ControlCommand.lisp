...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ControlCommand>)))
  ...
  (cl:format cl:nil "# Adapted from CLAP (https://github.com/CLAP-Framework/clap)~%Header header~%~%# Level of accelaration, unit in m/s^2, throttle is positive, braking is negative~%float32 accel~%~%# Level of steering on front wheel, unit in radian, left turning is positive~%float32 steer~%~%# Gear shift, positive means manual transmission, negative means automatic transmission~%int8 gear~%int8 GEAR_NONE = 0~%int8 GEAR_NEUTRAL = -1~%int8 GEAR_REVERSE = -2~%int8 GEAR_PARKING = -3~%int8 GEAR_DRIVE = -4~%~%# Parking brake switch~%bool parking_brake~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ControlCommand)))
  "Returns full string definition for message of type 'ControlCommand"
  (cl:format cl:nil "# Adapted from CLAP (https://github.com/CLAP-Framework/clap)~%Header header~%~%# Level of accelaration, unit in m/s^2, throttle is positive, braking is negative~%float32 accel~%~%# Level of steering on front wheel, unit in radian, left turning is positive~%float32 steer~%~%# Gear shift, positive means manual transmission, negative means automatic transmission~%int8 gear~%int8 GEAR_NONE = 0~%int8 GEAR_NEUTRAL = -1~%int8 GEAR_REVERSE = -2~%int8 GEAR_PARKING = -3~%int8 GEAR_DRIVE = -4~%~%# Parking brake switch~%bool parking_brake~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
