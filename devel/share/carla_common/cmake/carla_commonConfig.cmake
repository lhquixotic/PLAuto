...
if("TRUE" STREQUAL "TRUE")
  set(carla_common_SOURCE_PREFIX /home/user/code/PLAuto/src/drivers/simulators/carla/carla_ros_bridge/ros-bridge-0.9.11/carla_common)
  set(carla_common_DEVEL_PREFIX /home/user/code/PLAuto/devel)
  ...
  set(carla_common_INSTALL_PREFIX /home/user/code/PLAuto/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'carla_common' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/code/PLAuto/src/drivers/simulators/carla/carla_ros_bridge/ros-bridge-0.9.11/carla_common/${idir}'.  ${_report}")
    endif()
