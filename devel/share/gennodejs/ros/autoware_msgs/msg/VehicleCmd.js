...
class VehicleCmd {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Gear.serialize(obj.gear_cmd, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.gear_cmd = Gear.deserialize(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.gear_cmd !== undefined) {
      resolved.gear_cmd = Gear.Resolve(msg.gear_cmd)
    }
    else {
      resolved.gear_cmd = new Gear()
    }
