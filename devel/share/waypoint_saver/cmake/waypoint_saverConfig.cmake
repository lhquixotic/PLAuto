...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_saver_SOURCE_PREFIX /home/user/code/PLAuto/src/planning/waypoint_saver)
  set(waypoint_saver_DEVEL_PREFIX /home/user/code/PLAuto/devel)
  ...
  set(waypoint_saver_INSTALL_PREFIX /home/user/code/PLAuto/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_saver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/code/PLAuto/src/planning/waypoint_saver/${idir}'.  ${_report}")
    endif()
