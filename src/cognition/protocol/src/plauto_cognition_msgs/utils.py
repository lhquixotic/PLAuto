...
from plauto_cognition_msgs.msg import LaneState, MapState, RoadObstacle, JunctionMapState
from plauto_perception_msgs.msg import TrackingBoxArray, ObjectClass, DimensionWithCovariance
import numpy as np
