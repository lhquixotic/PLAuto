...
from plauto_cognition_msgs.utils import default_msg
from plauto_nav_msgs.msg import RigidBodyStateStamped
from plauto_nav_msgs.msg import LanePoint
from plauto_common.geometry import dist_from_point_to_polyline2d
...
class PathBuffer:
    ...
    def get_front_vehicle_on_reference_path(self, tstates, lane_dist_thres=2):
        ...
        if front_vehicle is not None:
            rospy.logdebug("front vehicle pos {}-{}, ego pos {}-{}, front distance {}".format(
