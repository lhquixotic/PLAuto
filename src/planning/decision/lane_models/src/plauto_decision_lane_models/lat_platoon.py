## Keep ego_vehiclr in current lane

import rospy
import numpy as np

from plauto_nav_msgs.utils import get_speed, get_yaw
from plauto_cognition_msgs.msg import MapState, RoadObstacle

class PlatoonLaneUtility(object):
    ...
    def lateral_decision(self, dynamic_map, platoon_state = None, close_to_junction = 10):
        ...
        if platoon_state is None:
            ...
            self.longitudinal_model_instance.update_platoon_state(platoon_state)
