...
class ControlHandle {
 ...
 private:
  ...
  ros::Subscriber decisionTrajectorySubscriber_;
  ...
  void decisionTrajectoryCallback(const plauto_planning_msgs::DecisionTrajectory &msg);
  ...
  std::string decision_trajectory_topic_name_;
